...
import { ProfileContainer, ProfileImageContainer, ProfileUserContainer, ProfileLogoutContainer } from './styles'
...
const Profile = ({showSignOutModal}: PofileProps) => {
  ...
  return (
    <ProfileContainer>
      ...
      <ProfileImageContainer onClick={goToProfile} image={session.user.image || '/images/default-user.png'} />
